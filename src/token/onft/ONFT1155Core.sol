...
abstract contract ONFT1155Core is NonblockingLzApp, ERC165, IONFT1155Core {
    ...
    {
        return
            interfaceId == type(IONFT1155Core).interfaceId || super.supportsInterface(interfaceId);
    }
    ...
    function _nonblockingLzReceive(
        ...
        (bytes memory toAddressBytes, uint256[] memory tokenIds, uint256[] memory amounts) = abi
            .decode(_payload, (bytes, uint256[], uint256[]));
        address toAddress;
        assembly {
